                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="draft" {{ old('status', $berita->status == 0 ? 'draft' : 'published') == 'draft' ? 'selected' : '' }}>Draft</option>
                                    <option value="published" {{ old('status', $berita->status == 1 ? 'published' : 'draft') == 'published' ? 'selected' : '' }}>Published</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
...
// Auto-generate excerpt dari konten jika kosong
